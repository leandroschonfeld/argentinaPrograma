...
VisitanteDAO VisitanteDAO = DAOFactory.getVisitanteDAO();
		
		visitantes=VisitanteDAO.getAll();
	//	System.out.println("-------------------------");
	...
	//	System.out.println("\nAtracciones:\n");
		...
		//System.out.println("\nPromociones:\n");
		 PromocionDAO PromocionDAO = DAOFactory.getPromocionDAO();
	        ...
	        promociones=PromocionDAO.leerPromociones(atracciones);
		//	System.out.println("\nPromociones:\n");
	...
	/**	try {
		...
		**/
		for(Atraccion_Promo x : v.getItinerario())
			...
			ItinerarioDAO.AddItinerario(v.getId(),x.getNombre());
	        }
		System.out.println("\n================================================================\n");
